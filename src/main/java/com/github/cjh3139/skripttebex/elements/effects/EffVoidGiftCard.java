...
@Name("Void Tebex Gift Card")
@Description(
    "Voids a gift card so its remaining balance can no longer be used. This effect waits for the Tebex API and " +
    "therefore delays the script."
)
@Examples("void the tebex giftcard {_card}")
@Since("1.0.0")
